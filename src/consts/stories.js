export const stories = [
  ...
  },
  {
    ...
    title: "Herencia",
    paragraphs: [
    "Los magos son algo complicados pues estos usan diferentes tipos de espadas de acuerdo al villano que se vayan a enfrentar  ",
    "en sí tienen dos tipos las espadas de fuego y las  espadas de frío cuando quieren que un villanos se congele y tengan una muerte congelada utilizan las espadas de frío",
    ...
    question: "¿Qué tipo de arma utilizan los magos ?",
    options: [
    "Una empanada",
    "Una espada",
    "Un perro",
