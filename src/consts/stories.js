...
export const stories = [
  ...
  },
  {
    ...
    title: "Herencia",
    paragraphs: [
      "Los paladines son algo complicados pues estos usan diferentes tipos de espadas de acuerdo al villano que se vayan a enfrentar.",
      "En sí tienen dos tipos: las espadas de fuego y las espadas de frío cuando quieren que un villanos se congele y tengan una muerte helada, utilizan las espadas de frío.",
      "Pero cuando quieren que mueran calientitos y rostizados pues en ese caso utilizan las espadas de fuego",
      "Las espadas de fuego y de frío tienen las mismas características a excepción que una utiliza el fuego y otra el frío.",
    ],
    question: "¿Qué tipo de arma utilizan los soldados?",
    options: ["Una empanada", "Una espada", "Un perro"],
    ifCorrect:
      "La herencia nos ayuda a reutilizar código a la hora de programar ya que una clase hija puede heredar los atributos y métodos de una clase padre (clases hija: espada de fuego y  espada de frío, clase padre: espada)",
    ifWrong: "¡Noooooooooo!, te equivocaste...",
    idxCorrect: 2,
    endCorrect: "",
    endWrong: "",
